...
import { Button, ButtonGroup, ControlGroup, Intent, Tooltip } from "@blueprintjs/core"
...
export class TTableConfig extends TTable {
    ...
    root: ConfigG // to avoid mobx error about changing observable without action   = new ConfigG(this)
    pasteBuffer: {
