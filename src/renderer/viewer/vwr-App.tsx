...
import { Button, ButtonGroup, Classes, ControlGroup, Popover, PopoverInteractionKind, Tooltip } from '@blueprintjs/core'
import '@blueprintjs/core/lib/css/blueprint.css'
import '@blueprintjs/table/lib/css/table.css'
import '@blueprintjs/icons/lib/css/blueprint-icons.css'
// OBSOLETE import '@blueprintjs/popover2/lib/css/blueprint-popover2.css'
...
export class App extends DnDApp {
  ...
  crTable: TTableCR
  // obsolete but we might bring it back?? ruleTable: TTableRule | undefined
  // obsolete but we might bring it back?? ruleTableVisible: boolean = false  // whether to show rule table instead of CR table
  ...
  constructor() {
    ...
    makeObservable(this, {
      ...
      // obsolete but we might bring it back??? ruleTable: observable.shallow,
      // obsolete but we might bring it back??? ruleTableVisible: observable,
      ...
      >
        <SplitterLayout
          ...
          onSecondaryPaneSizeChange={(value: number)=>{
            runInAction(()=>{app.pane2pxFromSplitterView = value})
          }}
        >
          <div 
